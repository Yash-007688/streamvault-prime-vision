...
Deno.serve(async (req: Request) => {
  ...
  const supabaseServiceKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJtcWJkZ3p5anR0aGpoa2hjc2d0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTQ3NjE3OSwiZXhwIjoyMDg3MDUyMTc5fQ." + "-vXTIAgohakmCU5UswhnH1_7yWmi1UVOZRTYwjY6ZsM";
